...
impl<'a> Parser<'a> {
    pub(in super::super::super) fn parse_for_statement(&mut self) -> Result<Statement, Error> {
        // guard
...
mod test {
    use crate::engine::{
        parse::{
            ast::{
                BinaryExpression, BlockStatement, CallExpression, Expression, ForInit,
                ForStatement, LetStatement, MemberExpression, Statement, UpdateExpression,
            },
            parser::Parser,
        },
